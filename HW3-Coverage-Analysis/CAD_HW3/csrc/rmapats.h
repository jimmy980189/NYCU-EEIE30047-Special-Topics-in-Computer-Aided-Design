...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I903;
    UB  * I904;
    struct _RmaMultiInputTable * I878;
    struct _RmaMultiInputTable * I906;
} RmaMultiInputTable;
...
typedef struct {
    U  I712;
    U  I720;
    RmaThreadSchedCompiledLoads  * I1007;
...
typedef struct {
    ...
    US  I1067;
    US  I1068;
    RemoteDbsedLoad   I1069[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I878;
    struct TableAssign_ * I796;
    U  I5;
    U  I1071 :1;
    U  I1072 :1;
    U  I1073 :2;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I878;
    struct TableAssignLayoutOnClk_ * I796;
    U  I5;
    U  I1071 :1;
    U  I1072 :1;
    U  I1073 :2;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I878;
    struct TableAssignLayoutOnClkOpt_ * I796;
    U  I1085;
    U  I1071 :1;
    U  I1072 :1;
    U  I1073 :2;
    ...
    U  I1080 :1;
    U  I368 :13;
    RmaSeqPrimOutputOnClkOpt  I1082;
    RmaSeqPrimOutputEblkData  I1086;
...
typedef struct RmaNonEdgeLoadHdr1_ {
    ...
    UB  I1151;
    UB  I975;
    RmaNonEdgeLoadData1  * I1051;
    RmaNonEdgeLoadData1  * I796;
    void * I1152;
} RmaNonEdgeLoadHdr1;
...
typedef struct RmaChildClockPropList1_ {
    RmaChildClockProp  * I1051;
    RmaChildClockProp  * I796;
...
struct futq_slot1 {
    U  I753;
    struct futq_slot2  I754[32];
};
struct futq_info {
    scalar  * I748;
    U  I749;
    U  I750;
    struct futq_slot1  I751[32];
};
struct futq {
    struct futq * I738;
    struct futq * I740;
...
struct dummyq_struct {
    ...
    struct futq * I1185;
    struct futq * I1186;
    struct sched_table * I1187;
    struct futq_info * I1189;
    ...
    int I1252;
    int I1253;
    struct vcs_globals_t * I1254;
    clock_struct  I1255;
    unsigned long long I1256;
    EBLK  * I1257;
    EBLK  * I1258;
    void * I1259;
};
